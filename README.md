...
[![Last-changedate](https://img.shields.io/badge/last%20change-2020--01--08-yellowgreen.svg)](/commits/master)
...
The goal of `ipmisc` is to gather miscellaneous helper functions that
are helpful for data cleaning and formatting.
