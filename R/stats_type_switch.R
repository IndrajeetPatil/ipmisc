...
#' @description Relevant mostly for `ggstatsplot` and `statsExpressions`, where
#'   there are four types of statistics are supported: parametric,
#'   non-parametric, robust, and Bayesian. This switch function converts strings
#'   entered by users to a common pattern.
#'
