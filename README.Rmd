...
Note that the current package build is faling because the function `ipmisc::summary_skim` and `ipmisc::partialeta_sq_ci`depend on the development version of `skimr` and `sjstats`, which can be downloaded here:
